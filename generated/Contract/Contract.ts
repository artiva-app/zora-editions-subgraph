...
export class Contract__getURIsResult {
  value0: string;
  value1: Bytes;
  value2: string;
  value3: Bytes;
...
export class Contract extends ethereum.SmartContract {
  ...
  getURIs(): Contract__getURIsResult {
    ...
    return new Contract__getURIsResult(
      result[0].toString(),
      result[1].toBytes(),
      result[2].toString(),
      result[3].toBytes()
  ...
  try_getURIs(): ethereum.CallResult<Contract__getURIsResult> {
    let result = super.tryCall(
      "getURIs",
      "getURIs():(string,bytes32,string,bytes32)",
      []
